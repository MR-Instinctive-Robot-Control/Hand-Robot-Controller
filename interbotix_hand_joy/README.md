...
As shown above, the *interbotix_hand_joy* package builds on top of the *interbotix_xsarm_control* package. To get pointers about the nodes in that package, please look at its README. The other nodes are described below:
...
```
roslaunch interbotix_hand_joy xsarm_joy.launch robot_model:=wx200
```
